...
final class ActionQueensBarButton: UIButton {
    init(title: String, imageName: String) {
        ...
        self.configuration = makeConfig(title: title, imageName: imageName)
    ...
    private func makeConfig(title: String, imageName: String) -> UIButton.Configuration {
